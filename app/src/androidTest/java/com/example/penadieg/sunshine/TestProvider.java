...
import com.example.penadieg.sunshine.data.WeatherContract;
import com.example.penadieg.sunshine.data.WeatherContract.LocationEntry;
import com.example.penadieg.sunshine.data.WeatherContract.WeatherEntry;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationUriWithDate(testLocation, testDate));
